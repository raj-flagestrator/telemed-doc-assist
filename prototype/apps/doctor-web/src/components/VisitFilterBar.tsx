...
const QUICK_STATUS_FILTERS: StatusFilter[] = ["all", "active"];
...
export function VisitFilterBar({
  ...
  function labelFor(id: StatusFilter): string {
    if (id === "all") return "All";
    if (id === "active") return "Active";
    return statusLabel(id);
  }

  const statusOptions: StatusFilter[] = [...QUICK_STATUS_FILTERS, ...VISIT_STATUSES];
